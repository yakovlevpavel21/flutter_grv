...
import 'package:grv/features/shipments/presentation/widgets/shipment_card.dart';
...
Map<DateTime, Map<DateTime, List<ShipmentEntity>>> groupByMonth(
  List<ShipmentEntity> items,
) {
  final result = <DateTime, Map<DateTime, List<ShipmentEntity>>>{};
